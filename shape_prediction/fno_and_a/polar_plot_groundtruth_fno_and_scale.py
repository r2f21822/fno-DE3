...
def main():
    ...
    #incompleto
    pa.add_argument("--amplitude-model", default="amlitude_prediction/linear_regression/", help="Caminho do modelo de amplitude")
    pa.add_argument("--out-dir", default="shape_prediction/fno_and_a/figures")

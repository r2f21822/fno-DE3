...
--idx_dir (diretorio da divisao dos indices de treino e teste, default="shared_idx/results"")
...
```texto
python amplitude_prediction/linear_regression/run_linear_regression_eps.py
   ```
treina um modelo de regressão linear para prever o log10 da amplitude + eps. Gera dois graficos, um de log10(amplitude_predita) vs log10(amplitude real) e um amplitude_predita vs amplitude_real, além de um arquivo .yaml com os coeficientes mae, rsm, r2 do modelo
Script para fins de comparação com o treinamento sem a constante 

...
def metricas(results_dir,modelo_dir):
    ...
    erro_percentual = (all_true_exp - all_pred_exp)
    ...
    # PLOT 1: Erro  e Amplitude correspondente ===================================================
    ...
    ax2.set_title(f'Erro Absoluto por Amostra\n{len(all_true_exp)} amostras', fontsize=13)
    ax2.grid(True, alpha=0.3)
    ax2.legend(loc='best')

    cbar2 = plt.colorbar(scatter2, ax=ax2)
    cbar2.set_label('Erro Absoluto (%)', fontsize=10)
    ...
    out_file = os.path.join(results_dir, "erro_por_amostra_ordenada.pdf")
